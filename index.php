...
<nav class="font-sans flex flex-col text-center content-center sm:flex-row sm:text-left sm:justify-between py-2 px-6 bg-white shadow sm:items-baseline w-full">
  <div class="mb-2 sm:mb-0 inner">
	...
	<a href="/home" class="text-2xl no-underline text-grey-darkest hover:text-blue-dark font-sans font-bold ">HamChops</a>
  ...
  <div class="sm:mb-0 self-center">
    ...
    <a href="https://google.com" class="text-md no-underline text-black transition hover:text-blue-500 ml-2 px-1">Meats</a>
